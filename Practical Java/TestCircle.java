...
public class TestCircle { // Save as "TestCircle.java"
    public static void main(String[] args) {
        ...
        System.out.println(
                "The " + c1.getColor() + " circle has radius of " + c1.getRadius() + " and area of " + c1.getArea());
        ...
        System.out.println(
                "The " + c2.getColor() + " circle has radius of " + c2.getRadius() + " and area of " + c2.getArea());
        // The circle has radius of 2.0 and area of 12.566370614359172

        Circle c3 = new Circle(3.0, "blue");
        // Invoke public methods on instance c2, via dot operator.
        System.out.println(
                "The " + c3.getColor() + " circle has radius of " + c3.getRadius() + " and area of " + c3.getArea());
